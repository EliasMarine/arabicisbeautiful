...
export function PhaseTabNav({ slug, tabs, color }: PhaseTabNavProps) {
  ...
  return (
    <nav className="max-w-[900px] mx-auto px-6 mt-4">
        ...
        {tabs.map((tab) => {
          ...
          return (
            <Link
              ...
              href={href}
              className={cn(
                "flex-shrink-0 px-4 py-2 rounded-md text-xs font-semibold uppercase tracking-wide transition-all whitespace-nowrap",
                isActive
